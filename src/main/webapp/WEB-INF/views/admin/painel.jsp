...
<title>Painel Administrativo - Guarulhos em Destaque</title>
<link rel="stylesheet"
	href="../resources/css/admin/simple-line-icons/css/simple-line-icons.css">
<link rel="stylesheet"
...
<body class="sidebar-fixed header-fixed">
	<div class="page-wrapper">
		<nav class="navbar page-header">
			<a href="#"
				...
				class="fa fa-bars"></i>
			</a> <a class="navbar-brand" href="#"> <img class="logo"src="../resources/assets/logo.jpg"
				alt="logo">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item dropdown"><a
					...
					<div class="dropdown-menu dropdown-menu-right">
						<a href="#" class="dropdown-item"> <i class="fa fa-lock"></i>
							Logout
						</a>
					</div></li>
			</ul>
					...
					<ul class="nav">
						...
						<li class="nav-item nav-dropdown"><a href="#"
							class="nav-link nav-dropdown-toggle"> <i
								class="icon icon-target"></i> Notícia <i
							...
							<ul class="nav-dropdown-items">
								...
								<li class="nav-item"><a href="layouts-fixed-sidebar.html"
									class="nav-link"> <i class="icon icon-target"></i> Listar
								</a></li>
							</ul></li>
							
							<li class="nav-item nav-dropdown"><a href="#"
							class="nav-link nav-dropdown-toggle"> <i
								class="icon icon-target"></i> Coluna <i
								class="fa fa-caret-left"></i>
						</a>
	...
	<script src="../resources/js/admin/chart.js/chart.min.js"></script>
	<script src="../resources/js/admin/carbon.js"></script>
